...
public class OriginDisplayScreen extends Screen {
    ...
    static final int[] DESCRIPTION_WINDOW = {10, 20, 10, 20};
    static final int[] RACE_WINDOW = {10, 20, 10, 20};
    static final int[] POWER_WINDOW = {10, 20, 10, 20};
    ...
    public void renderBackground(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        context.drawGuiTexture(WINDOW_BACKGROUND, RACE_WINDOW[0], RACE_WINDOW[1], -4, RACE_WINDOW[2], RACE_WINDOW[3]);
        context.drawGuiTexture(WINDOW_BACKGROUND, POWER_WINDOW[0], POWER_WINDOW[1], -4, POWER_WINDOW[2], POWER_WINDOW[3]);
        context.drawGuiTexture(WINDOW_BACKGROUND, DESCRIPTION_WINDOW[0], DESCRIPTION_WINDOW[1], -4, DESCRIPTION_WINDOW[2], DESCRIPTION_WINDOW[3]);

    }

    public void renderPlayerModel(DrawContext context, int mouseX, int mouseY) { //поченить поворот пресонажа
        if (player != null) {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        this.renderPlayerModel(context, mouseX, mouseY);
